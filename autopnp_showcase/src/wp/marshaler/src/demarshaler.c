...
/**
 * \brief  Performs demarshaling for topic 'image'.
 *
...
)
{
	...
	// char topicData->encoding
	{
		...
		for (i0 = 0; i0 < 20; i0++)
		{
			// char topicData->encoding
			{
				...
				topicData->encoding[i0] = hostValue;
				bufferPtr += 1;
			}
		}
	}
	...
	// uint8_t topicData->isBigEndian
	{
		...
		topicData->isBigEndian = hostValue;
		bufferPtr += 1;
	}
